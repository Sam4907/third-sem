...
odds1=np.array([3.20, 3.75, 1.90])
odds2=[0.57, 0.22, 0.21]
odds1=1/odds1
odds1=odds1/np.sum(odds1)

match1_probs={'mex':odds1[0], 'cze':odds1[1], 'tie':odds1[2]}
match2_probs={'sk':odds2[0], 'sa':odds2[1], 'tie':odds2[2]}

rem=[[df.iloc[0, 0], df.iloc[2, 0]], [df.iloc[1, 0], df.iloc[3, 0]]]
